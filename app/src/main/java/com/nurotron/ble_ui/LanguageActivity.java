...
/**
 * Created by Nurotron on 7/5/2017.
 */
...
public class LanguageActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        language = new GRadioGroup(inflatedView, R.id.chinese, R.id.english, R.id.spanish);
    ...
    public class GRadioGroup {
        ...
        public GRadioGroup(View activity, int... radiosIDs) {
            super();
            String language = sharedPrefs.getString(SettingsActivity.LANGUAGE);
            ...
            for (int radioButtonID : radiosIDs) {
                ...
                if (rb != null) {
                    ...
                    rb.setOnClickListener(onClick);
                    //if (true) rb.setChecked(true);
                }
                rb.setChecked(false);
                if (radioCount==0 && language.equals("zh")) rb.setChecked(true);
                else if (radioCount==1 && language.equals("en")) rb.setChecked(true);
                else if (radioCount==2 && language.equals("es")) rb.setChecked(true);
                radioCount++;
            }
        }
            ...
            public void onClick(View v) {
                ...
                switch (lanLabel) {
                    ...
                    case "Chino":
                        ...
                        sharedPrefs.putString(SettingsActivity.LANGUAGE, "zh");
                        break;
                    case "Spanish":
                    case "西班牙语":
                    case "Español":
                        System.out.println("Spanish");
                        sharedPrefs.putString(SettingsActivity.LANGUAGE, "es");
                        break;
                    default:
                        System.out.println("English");
                        sharedPrefs.putString(SettingsActivity.LANGUAGE, "en");
                        break;
                }
                rb.setChecked(true);
