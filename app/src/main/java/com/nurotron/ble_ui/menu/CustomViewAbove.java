...
import com.nurotron.ble_ui.menu.SlidingMenu.OnClosedListener;
import com.nurotron.ble_ui.menu.SlidingMenu.OnOpenedListener;
        ...
        switch (action & MotionEventCompat.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                if (mIsBeingDragged) {
                    ...
                    mActivePointerId = INVALID_POINTER;
                    endDrag();
                } else if (mQuickReturn && mViewBehind.menuTouchInQuickReturn(mContent, mCurItem, ev
                        .getX() + mScrollX)) {
                    // close the menu
                    setCurrentItem(1);
                    endDrag();
